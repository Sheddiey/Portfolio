...
const Projects = ({ projectsClass }) => {
  ...
  return (
    <Slider className={projectsClass} {...settings}>
      ...
      <div>
        <h3 className="font-semibold text-center mb-[5px]">
          Oningoi E-commerce Platform
        </h3>
        {isSmallScreen ? (
          <img
            className="h-[320px] w-[80%] mx-[auto]"
            src={oningoiDecalsPhone}
            alt=""
          />
        ) : (
      ...
      <div>
        ...
        <p className="text-[10px] mt-[5px]">
          Discover countries worldwide with a React-powered frontend showcasing
          filter by region and search functionalities, offering a seamless
          exploration experience of the REST Countries API.
        </p>
        <div className="flex justify-between duration-300 px-[100px] md:px-[250px] text-[20px]">
          <a
